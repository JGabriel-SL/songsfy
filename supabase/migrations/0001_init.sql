...
insert into public.songs (id, title, artist, year, genre, category, search_term, source) values
  ...
  ('senorita', 'SeÃ±orita', 'Shawn Mendes & Camila Cabello', 2019, 'Pop latino', 'pop', null, 'curated'),
  ...
  ('garota-de-ipanema', 'Garota de Ipanema', 'Tom Jobim & VinÃ­cius de Moraes', 1962, 'Bossa nova', 'brasil', 'Garota de Ipanema Antonio Carlos Jobim', 'curated'),
  ('tempo-perdido', 'Tempo Perdido', 'LegiÃ£o Urbana', 1986, 'Rock nacional', 'brasil', null, 'curated'),
  ('anna-julia', 'Anna JÃºlia', 'Los Hermanos', 1999, 'Rock nacional', 'brasil', null, 'curated'),
  ...
  ('pais-tropical', 'PaÃ­s Tropical', 'Jorge Ben Jor', 1969, 'MPB', 'brasil', null, 'curated'),
  ('velha-infancia', 'Velha InfÃ¢ncia', 'Tribalistas', 2002, 'MPB', 'brasil', null, 'curated'),
  ...
  ('deixa-acontecer', 'Deixa Acontecer', 'Grupo RevelaÃ§Ã£o', 2002, 'Pagode', 'brasil', null, 'curated'),
  ('fico-assim-sem-voce', 'Fico Assim Sem VocÃª', 'Claudinho & Buchecha', 2002, 'Funk melody', 'brasil', null, 'curated'),
  ('sorri-sou-rei', 'Sorri, Sou Rei', 'Natiruts', 2006, 'Reggae', 'brasil', null, 'curated'),
  ('evidencias', 'EvidÃªncias', 'ChitÃ£ozinho & XororÃ³', 1990, 'Sertanejo raiz', 'sertanejo', null, 'curated'),
  ('ai-se-eu-te-pego', 'Ai Se Eu Te Pego', 'Michel TelÃ³', 2011, 'Sertanejo universitÃ¡rio', 'sertanejo', null, 'curated'),
  ('e-o-amor', 'Ã‰ o Amor', 'ZezÃ© Di Camargo & Luciano', 1991, 'Sertanejo romÃ¢ntico', 'sertanejo', null, 'curated'),
  ('meteoro', 'Meteoro', 'Luan Santana', 2009, 'Sertanejo universitÃ¡rio', 'sertanejo', null, 'curated'),
  ('balada', 'Balada', 'Gusttavo Lima', 2011, 'Sertanejo universitÃ¡rio', 'sertanejo', null, 'curated'),
  ('camaro-amarelo', 'Camaro Amarelo', 'Munhoz & Mariano', 2012, 'Sertanejo universitÃ¡rio', 'sertanejo', null, 'curated'),
  ('amo-noite-e-dia', 'Amo Noite e Dia', 'Jorge & Mateus', 2011, 'Sertanejo universitÃ¡rio', 'sertanejo', null, 'curated'),
  ('medo-bobo', 'Medo Bobo', 'Maiara & Maraisa', 2016, 'SofrÃªncia', 'sertanejo', null, 'curated'),
  ('infiel', 'Infiel', 'MarÃ­lia MendonÃ§a', 2015, 'SofrÃªncia', 'sertanejo', null, 'curated'),
  ('notificacao-preferida', 'NotificaÃ§Ã£o Preferida', 'ZÃ© Neto & Cristiano', 2019, 'Sertanejo universitÃ¡rio', 'sertanejo', null, 'curated'),
  ('regime-fechado', 'Regime Fechado', 'Simone & Simaria', 2018, 'SofrÃªncia', 'sertanejo', null, 'curated'),
  ('jenifer', 'Jenifer', 'Gabriel Diniz', 2018, 'ForrÃ³', 'sertanejo', null, 'curated'),
  ...
  ('where-are-u-now', 'Where Are Ãœ Now', 'Skrillex & Diplo (Justin Bieber)', 2015, 'Future bass', 'eletronica', 'Where Are U Now Skrillex Diplo Justin Bieber', 'curated'),
